      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1A2B4A]/20 p-4 backdrop-blur-sm">
        ...
        >
          <div className="flex items-center justify-between border-b border-[#f3f4f6] px-5 py-3">
            <h2 className="text-base font-semibold text-[#1A2B4A]">User Details</h2>
          ...
          <div className="px-5 py-4 max-h-[75vh] overflow-y-auto">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[#f3f4f6]">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#1A2B4A]">{user.full_name}</h3>
          ...
          <div className="border-t border-[#f3f4f6] bg-[#f8f4ef]/50 px-5 py-3 flex justify-end">
            <button
              onClick={onClose}
              className="rounded-xl border border-[#e5e1d8] bg-white px-4 py-1.5 text-sm font-semibold text-[#6B7280] shadow-sm transition-colors hover:bg-gray-50"
            >
              Close
            </button>
          </div>
