...
const auditLogs = [
  { id: "1", user: "Platform Admin", action: "User Role Changed", target: "Ama Owusu → peer_coach", timestamp: "2026-10-15 14:32", status: "success" },
  ...
  { id: "3", user: "Dr. Grace Asare", action: "Session Completed", target: "Counselling session with Efua Sackey", timestamp: "2026-10-13 16:45", status: "success" },
  { id: "4", user: "System", action: "ODIP Sync", target: "10 pairings synced from ODIP", timestamp: "2026-10-12 03:00", status: "success" },
  ...
  { id: "8", user: "Prof. Kwesi Arthur", action: "Session Booked", target: "Advising with Adwoa Sarpong", timestamp: "2026-10-08 10:30", status: "success" },
    ...
    <AnimatedPage>
      ...
      <DataTable
        columns={[
          ...
          { key: "target", header: "Target / Details", render: (log: any) => <span className="text-[#6B7280] text-xs">{log.target}</span> },
