  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <View style={styles.headerContainer}>
        <Text style={styles.header}>Academic Advising</Text>
        <Text style={styles.subHeader}>
          Get guidance on course registration, majors, and academic policies.
        </Text>
      </View>

      <View style={styles.bookCard}>
        <View style={styles.bookIconBg}>
          <IconSymbol name="book.fill" size={28} color="#1A2B4A" />
        </View>
        <Text style={styles.bookTitle}>Book an Advisor</Text>
        <Text style={styles.bookDesc}>
          Schedule a 1-on-1 session with your academic advisor. We recommend meeting at least once per semester.
        </Text>
        <TouchableOpacity style={styles.primaryButton} activeOpacity={0.8}>
          <IconSymbol name="calendar" size={18} color="#FFFFFF" />
          <Text style={styles.primaryButtonText}>View Availability</Text>
        </TouchableOpacity>
      </View>
            ...
            <View key={session.id} style={styles.sessionCard}>
              ...
              <View style={styles.sessionInfo}>
                ...
                <Text style={styles.sessionLocation}>
                  <IconSymbol name="mappin.and.ellipse" size={14} color="#6B7280" /> {session.location || "Advisor Office"}
                </Text>
...
const styles = StyleSheet.create({
  ...
  sessionDateBadgeMonth: { fontSize: 13, fontWeight: "800", color: "#1A2B4A", marginBottom: 2 },
